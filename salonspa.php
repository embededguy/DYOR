...
$query = "SELECT * FROM tblproduct_p WHERE tblProduct_P_Category = $category  AND tblProduct_P_Status = 1";
...
<html lang="en">
   ...
   <body>
      <div class="page-wrapper">
         ...
         <main class="main">
            <div class="page-header" style="background-image: url('images/shop/salonspa.jpg'); background-color: #3C63A4;">
